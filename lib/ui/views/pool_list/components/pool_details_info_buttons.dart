    ...
    if (aedappfm.Responsive.isDesktop(context) ||
      ...
      return Column(
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: _addLiquidityButton(context, ref, poolItem),
              ),
              Expanded(
                child: _removeLiquidityButton(context, ref, poolItem),
              ),
            ],
          ),
        ],
      ...
      return Column(
        children: [
          ...
          _addLiquidityButton(context, ref, poolItem),
          const SizedBox(
            height: 10,
          ),
          _removeLiquidityButton(context, ref, poolItem),
        ],
      );
    }
  }
