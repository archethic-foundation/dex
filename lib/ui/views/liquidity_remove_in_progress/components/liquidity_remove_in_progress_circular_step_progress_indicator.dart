...
class LiquidityRemoveInProgressCircularStepProgressIndicator
    extends ConsumerWidget {
  const LiquidityRemoveInProgressCircularStepProgressIndicator({
    super.key,
  });
        ...
        child: Stack(
          ...
          children: [
            CircularStepProgressIndicator(
              ...
              gradientColor: liquidityRemove.isProcessInProgress == false
            ...
            Stack(
              alignment: Alignment.center,
              children: [
                if (liquidityRemove.isProcessInProgress)
                  SizedBox(
                    width: 25,
                    height: 25,
