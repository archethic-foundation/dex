...
class InfoBanner extends StatelessWidget {
  const InfoBanner(
    ...
    this.infoBannerType, {
    this.height = 40,
    this.width = DexThemeBase.sizeBoxComponentWidth,
                          ...
                          color: infoBannerType == InfoBannerType.error
                              ...
                              : infoBannerType == InfoBannerType.request
                                  ? Theme.of(context)
                                      ...
                                      .primary
                                      .withOpacity(0.6)
                                  : DexThemeBase.statusOK.withOpacity(0.6),
                          width: 0.5,
                        ),
                        gradient: DexThemeBase.gradientInfoBannerBackground,
                      ),
                      child: Container(
