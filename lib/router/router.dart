...
final dexRoutes = [
  GoRoute(
    ...
    pageBuilder: (context, state) {
      final tokenToSwap = state.uri.queryParameters.getDecodedParameter(
        'tokenToSwap',
        (json) => DexToken.fromJson(jsonDecode(json)),
      );
      final tokenSwapped = state.uri.queryParameters.getDecodedParameter(
        'tokenSwapped',
        (json) => DexToken.fromJson(jsonDecode(json)),
      );
  ...
  GoRoute(
    ...
    pageBuilder: (context, state) {
      ...
      final poolsListTab = state.uri.queryParameters.getDecodedParameter(
        'tab',
  ...
  GoRoute(
    ...
    pageBuilder: (context, state) {
      final farmAddress = state.uri.queryParameters.getDecodedParameter(
        'farmAddress',
        jsonDecode,
      );
      final poolAddress = state.uri.queryParameters.getDecodedParameter(
        'poolAddress',
        jsonDecode,
      );
  ...
  GoRoute(
    ...
    pageBuilder: (context, state) {
      ...
      final lpTokenAddress = state.uri.queryParameters.getDecodedParameter(
        'lpTokenAddress',
        jsonDecode,
      );
      final rewardAmount = state.uri.queryParameters.getDecodedParameter(
