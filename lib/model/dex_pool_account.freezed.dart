...
/// @nodoc
abstract class _$$_DexPoolAccountCopyWith<$Res>
    implements $DexPoolAccountCopyWith<$Res> {
  factory _$$_DexPoolAccountCopyWith(
          _$_DexPoolAccount value, $Res Function(_$_DexPoolAccount) then) =
      __$$_DexPoolAccountCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({DexPool pool, double token1Amount, double token2Amount});
...
/// @nodoc
class __$$_DexPoolAccountCopyWithImpl<$Res>
    extends _$DexPoolAccountCopyWithImpl<$Res, _$_DexPoolAccount>
    implements _$$_DexPoolAccountCopyWith<$Res> {
  __$$_DexPoolAccountCopyWithImpl(
      _$_DexPoolAccount _value, $Res Function(_$_DexPoolAccount) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_DexPoolAccount(
      pool: null == pool
          ? _value.pool
          : pool // ignore: cast_nullable_to_non_nullable
              as DexPool,
...
class _$_DexPoolAccount implements _DexPoolAccount {
  const _$_DexPoolAccount(
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_DexPoolAccountCopyWith<_$_DexPoolAccount> get copyWith =>
      __$$_DexPoolAccountCopyWithImpl<_$_DexPoolAccount>(this, _$identity);
}
...
abstract class _DexPoolAccount implements DexPoolAccount {
  const factory _DexPoolAccount(
      {final DexPool pool,
      final double token1Amount,
      final double token2Amount}) = _$_DexPoolAccount;
