...
/// @nodoc
abstract class _$$_DexPoolCopyWith<$Res> implements $DexPoolCopyWith<$Res> {
  factory _$$_DexPoolCopyWith(
          _$_DexPool value, $Res Function(_$_DexPool) then) =
      __$$_DexPoolCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String poolAddress,
...
/// @nodoc
class __$$_DexPoolCopyWithImpl<$Res>
    extends _$DexPoolCopyWithImpl<$Res, _$_DexPool>
    implements _$$_DexPoolCopyWith<$Res> {
  __$$_DexPoolCopyWithImpl(_$_DexPool _value, $Res Function(_$_DexPool) _then)
      : super(_value, _then);
...
class _$_DexPool implements _DexPool {
  const _$_DexPool(
      {this.poolAddress = '',
      this.ranking = 0,
      this.pair,
  ...
  @override
  String toString() {
    return 'DexPool(poolAddress: $poolAddress, ranking: $ranking, pair: $pair, token1Pooled: $token1Pooled, token2Pooled: $token2Pooled, amountOfLiquidity: $amountOfLiquidity, apr: $apr, volume24h: $volume24h, volume7d: $volume7d, fees24h: $fees24h)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_DexPoolCopyWith<_$_DexPool> get copyWith =>
      __$$_DexPoolCopyWithImpl<_$_DexPool>(this, _$identity);
}
...
abstract class _DexPool implements DexPool {
  const factory _DexPool(
      ...
      final double volume24h,
      final double volume7d,
      final double fees24h}) = _$_DexPool;
