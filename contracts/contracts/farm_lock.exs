...
export fun(get_farm_infos()) do
  ...
  years = [
    ...
    [year: 2, start: @START_DATE + year, end: @START_DATE + 2 * year - 1, rewards: @REWARDS_YEAR_2],
    [year: 3, start: @START_DATE + 2 * year, end: @START_DATE + 3 * year - 1, rewards: @REWARDS_YEAR_3],
  ...
  for level in ["0", "1", "2", "3", "4", "5", "6", "7"] do
    ...
    for y in years do
      ...
      rewards_allocated = List.append(rewards_allocated, [start: y.start, end: y.end, rewards: rewards])
    end
